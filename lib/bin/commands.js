...
exports.ft = exports.downgrade = exports.upgrade = exports.evict = exports.movein = exports.work = exports.showTenants = void 0;
    ...
    if (!userCursor) {
        ...
        if (userCursor.worked) {
            ...
            yield closet.updateOne({ id: id }, {
                $set: {
                    money: oldMoney + constants_1.wage,
                    worked: true
                }
            });
            channel.send(`**${userCursor.name}** ${constants_1.jobs[Math.floor(Math.random() * constants_1.jobs.length)]}. They made $${constants_1.wage} and now have $${oldMoney + constants_1.wage} in their bank account!`);
        }
    }
});
exports.work = work;
