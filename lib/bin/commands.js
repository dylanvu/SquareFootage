...
const work = (mongoclient, channel, msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userCursor) {
        ...
        if (userCursor.worked) {
            ...
            channel.send(`**${userCursor.name}**, You went to work! You ${constants_1.jobs[Math.floor(Math.random() * constants_1.jobs.length)]}. You made **$${newMoney.toLocaleString()}** and now have **$${(oldMoney + newMoney).toLocaleString()}** in your bank account!`);
        }
    }
});
exports.work = work;
