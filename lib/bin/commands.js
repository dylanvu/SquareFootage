...
const work = (mongoclient, channel, msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userCursor) {
        ...
        if (userCursor.worked) {
            ...
            channel.send(`**${userCursor.name}** ${constants_1.jobs[Math.floor(Math.random() * constants_1.jobs.length)]}. They made **$${newMoney.toLocaleString()}** and now have **$${(oldMoney + newMoney).toLocaleString()}** in their bank account!`);
        }
    }
});
exports.work = work;
