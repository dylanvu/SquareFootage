...
exports.roleCleanup = exports.roleSetup = exports.ft = exports.downgrade = exports.upgrade = exports.evict = exports.movein = exports.buy = exports.slots = exports.gamble = exports.work = exports.showTenants = void 0;
...
const work = (mongoclient, channel, msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!userCursor) {
        ...
        if (userCursor.worked) {
            ...
            channel.send(`**${userCursor.name}** ${constants_1.jobs[Math.floor(Math.random() * constants_1.jobs.length)]}. They made **$${newMoney.toLocaleString()}** and now have **$${oldMoney + newMoney}** in their bank account!`);
        }
    }
});
exports.work = work;
...
const buy = (mongoclient, channel, msg) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const collection = yield mongoclient.db().collection("closet");
    const id = msg.author.id;
