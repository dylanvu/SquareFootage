...
exports.buy = exports.work = exports.showTenants = exports.sigh = exports.howAreYou = exports.goStudy = void 0;
...
const sigh = (mongoclient, msg, channel) => __awaiter(void 0, void 0, void 0, function* () {
    let collection = mongoclient.db().collection("sigh");
    // parse arguments for names
    const names = (0, util_1.SplitArgs)(msg.content);
