...
exports.roundToDecimal = exports.randomPhrase = exports.randomNumber = exports.RandomFt = exports.SplitArgsWithCommand = exports.SplitArgs = exports.ParseMention = void 0;
/**
 *
...
const randomPhrase = (arr) => {
    const index = (0, exports.randomNumber)(0, arr.length - 1);
    return arr[index];
};
