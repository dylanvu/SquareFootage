...
exports.jobs = [
    ...
    "sold some sourdough rolls you baked the night before",
    ...
    "gave advice to a bunch of ChemE freshmen and a grateful parent thanked you for your help",
    ...
    "used your totally legitimate knowledge of Japanese to translate a chapter of someone's favorite manga",
    ...
    "got hit by a bus and were given some money to not sue",
    "witnessed a sketchy backroom deal in the ChE closet and were given hush money to keep quiet",
    "were asked to write a review of the *Bee* movie. Once you finished putting a scathing review on Rotten Tomatoes, a rabid fan tracked you down and threateneed you personally in IV to change your review. After some forceful convincing on the fan's part, the review was changed to praise the movie as one of the best movies of the entire century and deserving of pretty much every single Oscar award: *Barry B Benson* as best actor, the Bee movie for the greatest original score, and its numerous translations winning best forign film. The review then garnered world-wide attention to such a high degree that the Academy had no choice but to reconsider the *Bee* movie for the 2007 Oscars. Unfortunately, the movie did not gain any new awards but the fan, so grateful, went back and slipped in some money into a myserious backpack with a special personalized note expressing their undying love for the movie alongside an invitation for you to join the *Bee* movie fanclub at UCSB has been extended, only if the money is taken. Welcome to the fanclub",
    "were asked to cut two people's hair and did a good enough job to make a few bucks",
    "rented out your kitchen for someone's \"baking\" party (whatever that is)",
    ...
    "insisted on guiding an old lady across campus to visit her grandchild in Anacapa. Grateful, the old lady gave $1, but mistakingly slipped in some extra cash on top of that",
    "offered your protection services to a young Freshman to protect them from the bands of raccoons roaming campus",
    "fixed up someone's broken bike",
    "were walking to class when a doordash scooter nearly crashed into them, hitting a wall instead. A tragedy, but the doordash order of soup was going to get cold! So, you took over the doordash order instead, driving to Santa Barbara and receiving a generous tip from the millionaire that ordered the soup",
    ...
    "set a new world record for most volume of tears cried after you saw the latest grade on your lab report and was paid by Guiness World Records",
    "got a certificate and small prize for knowing 100 digits of pi",
    "discovered a new type of rock and submitted it to the International Rock Committee. The committee, overjoyed, gave a cash prize. Little did you know, the rock was actually a hardened piece of candy, but it was too late",
    ...
    "participated in a bet that you couldn't ride your bike without hands for more than 1 yard. After you rode for 1.01 yards without hands, fell over, and got concussed, the money was hesitantly forked over. Hey, money's money right? The bank account is now heavier with more cash",
    ...
    "drove a bunch of AIChE members to a hike. Since you didn't get lost and arrived on time, you got some money and more to pay for gas and the good service",
    "put on a sock puppet show in Girvetz Hall and received a surprising amount of tips",
    "guided a poor lost child in Target to their worried mom. Relieved, she said that you just had to take some money",
    "smuggled illicit pebbles stolen from the beach across city lines to an avid rock collector back from where you're from",
    "left some money in a pocket a few months ago and finally found it",
    "thought of a really cool idea for this bot",
    "taught some people how to skateboard",
    "got asked to sneakily take photos of someone like an amateur private investigator. Creepy",
    "found a wallet on the ground and made some money disappear. That's kinda yikes",
];
