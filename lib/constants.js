...
exports.jobs = exports.roles = exports.commandList = exports.landlordID = exports.costPerSqFt = exports.debtAdjustment = exports.range = exports.wage = exports.defaultMoney = exports.defaultFt = exports.mongoDBcollection = void 0;
// SOFTWARE CONSTANTS
...
exports.commandList = ["!movein", "!evict", "!upgrade", "!downgrade", "!ft", "!resetwork"]; // commands that will deduct square feet if used by a tenant
// lists of things
...
exports.roles = [
    ...
    {
        role: "I Could Have Bought 1,000 Square Feet But Instead I Have a Useless Title",
        price: 200000
    },
    {
    ...
    {
        role: "Dylan House Owner (Excluding Closet)",
        price: 500000
    },
    {
    ...
    {
        role: "I Can Ask Dylan Any One Question",
        price: 750000
    },
    {
        role: "Closet Mascot",
